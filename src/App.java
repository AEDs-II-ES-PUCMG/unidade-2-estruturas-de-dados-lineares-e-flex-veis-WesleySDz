...
public class App {
     ...
     * de produto informado pelo usuário, e o retorna. Em caso de não encontrar
     * o produto, retorna null
     */
     ...
     * produto informado pelo usuário, e o retorna. A busca não é sensível ao
     * caso. Em caso de não encontrar o produto, retorna null
     *
    ...
    /**
     * Inicia um novo pedido. Permite ao usuário escolher e incluir produtos no
     * pedido.
     *
    ...
    /**
     * Finaliza um pedido, momento no qual ele deve ser armazenado em uma pilha
     * de pedidos.
     *
    ...
    public static void finalizarPedido(Pedido pedido) {
        ...
        ItemDePedido[] itensDePedido = pedido.getItensDoPedido();
        int quantidadeItensDePedido = 0;
        for (int i = 0; i < itensDePedido.length && itensDePedido[i] != null; i++) {
            if (itensDePedido[i] == null) {
                break;
            }
            pilhaProdutosMaisRecentes.empilhar(itensDePedido[i].getProduto());
            quantidadeItensDePedido++;
        }
